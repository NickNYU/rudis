...
impl EventLoopFlag {
    pub(crate) fn is_file_event(&self) -> bool {
        self.flags & AE_FILE_EVENTS > 0
    }

    pub(crate) fn is_time_event(&self) -> bool {
        self.flags & AE_TIME_EVENTS > 0
    }

    pub(crate) fn is_all_event(&self) -> bool {
        self.flags & AE_ALL_EVENTS > 0
    }

    pub(crate) fn is_dont_wait(&self) -> bool {
        self.flags & AE_DONT_WAIT > 0
    }

    pub(crate) fn is_call_after_sleep(&self) -> bool {
        self.flags & AE_CALL_AFTER_SLEEP > 0
    }

    pub(crate) fn is_call_before_sleep(&self) -> bool {
        self.flags & AE_CALL_BEFORE_SLEEP > 0
    }
}
